...
public class DatabaseManager {
    ...
    public WorkRoutine loadWorkRoutineByIdLazily(int id){
        return workRoutineDAO.getWorkRoutineById(id, true);
    }
    ...
    public void saveRoutineFromUser(WorkRoutine workRoutine) {
        ...
        workRoutine.setWorkoutDuration(workoutDuration.getSeconds());
        workRoutine.setWorkoutDurationInString(String.valueOf(workoutDuration.getSeconds()));
    }
}
